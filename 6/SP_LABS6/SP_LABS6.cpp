...
void AddMenus(HWND hwnd)
{
	...
	AppendMenuW(hMenu, MF_STRING, QUIT_CLICKED, L"&Quit");
	...
	HWND hWnd, UINT message, WPARAM wParam, LPARAM lParam)
{
	...
	case WM_COMMAND:
		...
		case QUIT_CLICKED: 
		{
			int retval = ::_tsystem(_T("taskkill /F /T /IM SP_LABS6.exe"));
		}
		break;
		}
...
ATOM RegMyWindowClass(HINSTANCE hInst, LPCTSTR lpzClassName) // 2
{
...
int APIENTRY WinMain(HINSTANCE hInstance, // 1
...

{
	...
	HWND hWnd = CreateWindow(lpzClass, _T("My Window"),
