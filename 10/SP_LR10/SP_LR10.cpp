...
#define RB_GREEN 279
#define RB_BLUE 280
#define RB_RHOMBUS 281
#define RB_SQUARE 282
#define RB_CIRCLE 283
#define RB_STAR 284
#define CHECKBOX 285
...
#define WANT_TO_DRAW WM_USER + 1
#define DRAW_NOW WM_USER + 2
...
BOOL InitInstance(HINSTANCE hInstance, int nCmdShow)
{
   ...
   radiobuttonRed = CreateWindow(L"BUTTON",
       ...
       20, 20, 100, 20, hWnd, (HMENU)RB_RED, hInst, NULL);
   radiobuttonGreen = CreateWindow(L"BUTTON",
       L"Green",
       WS_VISIBLE | WS_CHILD | BS_AUTORADIOBUTTON,
       20, 50, 100, 20, hWnd, (HMENU)RB_GREEN, hInst, NULL);
   radiobuttonBlue = CreateWindow(L"BUTTON",
       L"Blue",
       WS_VISIBLE | WS_CHILD | BS_AUTORADIOBUTTON,
       20, 80, 100, 20, hWnd, (HMENU)RB_BLUE, hInst, NULL);
   radiobuttonRhombus = CreateWindow(L"BUTTON",
       L"Rhombus",
       WS_VISIBLE | WS_CHILD | BS_AUTORADIOBUTTON | WS_GROUP,
       140, 20, 100, 20, hWnd, (HMENU)RB_RHOMBUS, hInst, NULL);
   radiobuttonSquare = CreateWindow(L"BUTTON",
       L"Square",
       WS_VISIBLE | WS_CHILD | BS_AUTORADIOBUTTON,
       140, 50, 100, 20, hWnd, (HMENU)RB_SQUARE, hInst, NULL);
   radiobuttonCircle = CreateWindow(L"BUTTON",
       L"Circle",
       WS_VISIBLE | WS_CHILD | BS_AUTORADIOBUTTON,
       140, 80, 100, 20, hWnd, (HMENU)RB_CIRCLE, hInst, NULL);
   radiobuttonStar = CreateWindow(L"BUTTON",
       L"Star",
       WS_VISIBLE | WS_CHILD | BS_AUTORADIOBUTTON,
       140, 110, 100, 20, hWnd, (HMENU)RB_STAR, hInst, NULL);
...
LRESULT CALLBACK WndProc(HWND hWnd, UINT message, WPARAM wParam, LPARAM lParam)
{
    ...
    case WANT_TO_DRAW: {
        ...
        if (isCheckedStar == BST_CHECKED)
            lParam = (LPARAM)STAR;
        SendMessageW(canvasWindow, DRAW_NOW, wParam, lParam);
        break;
    }
    case WM_COMMAND:
    {
...
LRESULT CALLBACK WndProc2(HWND hWnd, UINT message, WPARAM wParam, LPARAM lParam)
{
    ...
    case WM_LBUTTONDOWN:
        xPos = LOWORD(lParam);
        yPos = HIWORD(lParam);
        SendMessage(mainHWnd, WANT_TO_DRAW, NULL, NULL);
        break;
    case WM_COMMAND:
    {
        int wmId = LOWORD(wParam);
